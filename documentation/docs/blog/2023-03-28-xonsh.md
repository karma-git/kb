...
Попробуем воспроизвести такой workflow (изначально жил в [dotfiles/warp-workflows](https://github.com/karma-git/kb/blob/04d6a1c4c1f2baa90026d91ccec9a5d78fbd980d/dotfiles/warp-workflows/aws-k8s-terminate-node.yml), позже перенесён на go-task в [karma-git/workspace](https://github.com/karma-git/workspace/blob/master/dotfiles/taskfiles/aws.yml)):
